...
public class MusicConfig
{
    ...
    private static string GetDefaultFfprobePath()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            return @"C:\Program Files\ffmpeg\bin\ffprobe.exe";
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
    ...
    {
        Console.WriteLine("Welcome to Music Configuration Setup!");
        ...
        var config = new MusicConfig
        {
            ...
            FfprobePath = PromptForValue("FFprobe Path", GetDefaultFfprobePath()),
    ...
    public static string ConfigPath
    {
        get
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                defaultConfigPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Music", "config.json");
            }
            else
            {
