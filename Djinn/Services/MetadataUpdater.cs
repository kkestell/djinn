...
//            var tagFile = File.Create(audioFile.FullName);
...
//            tagFile.Tag.AlbumArtists = new[] { album.Artist.Name };
//            tagFile.Tag.AlbumArtistsSort = new[] { album.Artist.SortName };
//            tagFile.Tag.Artists = new[] { album.Artist.Name };
//            tagFile.Tag.Year = (uint)album.Year;
